...
public class FreshMart {
    public static void main(String[] args) {
        GroceryItem[] inventory = {
            ...
            new Snacks("Sweet Cookies", 2.50, 30),
            new Snacks("Spicy Nuts", 3.00, 100),
            new FrozenTreats("Ice Cream", 4.00, 250),
            new FrozenTreats("Frozen Yogurt", 3.50, 250),
